...
class IngApplicationTest {
    ...
    private final Javalin app = IngApplication.createJavalinServer();
    ...
    @Test
    void testOnlineGameEndpointWithSampleData() {
    ...
    @Test
    void testTransactionsEndpointWithSampleData() {
    ...
    private void testEndpoint(final String endpoint, final String request, final String expectedResponse) {
        JavalinTest.test(app, (server, client) -> Assertions.assertEquals(expectedResponse, executeCall(client, endpoint, request)));
    }
